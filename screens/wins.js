...
export default function Wins({ navigation }) {
    ...
    <Provider>
      <Portal>
        ...
        <Wrapper>
          ...
          <View style={styles.expBtn_cont}>
            <View style={styles.expBtn_box}>
              <Export_Selected action={showModal} />
              <Export_All action={showModal} />
            </View>
          </View>
